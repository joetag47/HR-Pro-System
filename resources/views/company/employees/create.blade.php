                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group fv-plugins-icon-container has-danger">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg is-invalid" name="fname" placeholder="First Name" value="">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container has-danger">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg is-invalid" name="lname" placeholder="Last Name" value="">
                                                    </div>
                                                    </div>
                                                </div>
                                                <!--end::Input-->
...
@endsection
@push('page-js')
            <script src="{{ asset('assets/custom_scripts/js/employee_form.js') }}"></script>
    @endpush
