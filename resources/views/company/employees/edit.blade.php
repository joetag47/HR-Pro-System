                ...
                <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                    ...
                    <div class="d-flex align-items-center mr-1">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                            <!--begin::Page Title-->
                            <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Update Employee ({{ $employee->name }})</h2>
                            <!--end::Page Title-->
                        </div>
                        <!--end::Page Heading-->
                    </div>
                            ...
                            <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
                                ...
                                <div class="row">
                                    <div class="offset-xxl-2 col-xxl-8">
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework employeeForm" id="kt_form" method="POST" enctype="multipart/form-data" action="{{ route('company.employee.update', $employee->id) }}">
                                            @csrf
                                            @method('POST')
                                            <!--begin: Wizard Step 1-->
                                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                <h4 class="mb-10 font-weight-bold text-dark">Enter your Employee Personal Details</h4>
{{--                                                {{ json_encode($employee->education) }}--}}
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group fv-plugins-icon-container has-danger">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg is-invalid" name="full_name" placeholder="Full Name" value="{{ old('full_name') ?? $employee->name }}">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="form-group fv-plugins-icon-container has-danger">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg is-invalid" name="email" placeholder="Email Address" value="{{ old('email') ?? $employee->email }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end::Input-->
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container has-success">
                                                            ...
                                                            <input type="date" class="form-control form-control-solid form-control-lg" name="date_of_birth" value="{{ old('date_of_birth') ?? $employee->date_of_birth }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container has-success">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="place_of_birth" value="{{ old('place_of_birth') ?? $employee->place_of_birth }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="residential_address" value="{{ old('residential_address') ?? $employee->residential_address }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="digital_address" value="{{ old('digital_address') ?? $employee->digital_address }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="tel" class="form-control form-control-solid form-control-lg" name="phone_number" value="{{ old('phone_number') ?? $employee->phone_number }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <select name="identity_type" class="form-control">
                                                                ...
                                                                <option value="voters_id" {{ old('identity_type') || $employee->identity_type === 'voters_id' ? 'selected' : null }}>Voter's ID</option>
                                                                <option value="passport" {{ old('identity_type') || $employee->identity_type === 'passport' ? 'selected' : null }}>Passport</option>
                                                                <option value="national_id" {{ old('identity_type') || $employee->identity_type === 'national_id' ? 'selected' : null }}>National ID</option>
                                                                <option value="nhis" {{ old('identity_type') || $employee->identity_type === 'nhis' ? 'selected' : null }}>NHIS</option>
                                                                <option value="drivers_license" {{ old('identity_type') || $employee->identity_type === 'drivers_license' ? 'selected' : null }}>Driver's License</option>
                                                            </select>
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="fathers_name" value="{{ old('fathers_name') ?? $employee->fathers_name }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6" style="margin-top: 8%;">
                                                        <div class="form-group fv-plugins-icon-container">
                                                            <label class="checkbox">
                                                                <input type="checkbox" name="father_deceased" {{ old('father_deceased') || $employee->father_deceased == true ? 'checked': null }}/>
                                                                <span></span>
                                                                Deceased?
                                                            </label>
                                                            <!--end::Input-->
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="mothers_name" value="{{ old('mothers_name') ?? $employee->mothers_name }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6" style="margin-top: 8%;">
                                                        <div class="form-group fv-plugins-icon-container">
                                                            <label class="checkbox">
                                                                <input type="checkbox" name="mother_deceased" {{ old('mother_deceased') || $employee->mother_deceased == true ? 'checked': null }}/>
                                                                <span></span>
                                                                Deceased?
                                                            </label>
                                                            <!--end::Input-->
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <select name="marital_status" class="form-control">
                                                                <option value="Married" {{ old('marital_status') || $employee->marital_status === 'Married' ? 'selected' : null }}>Married</option>
                                                                <option value="Single" {{ old('marital_status') || $employee->marital_status === 'Single' ? 'selected' : null }}>Single</option>
                                                                <option value="Divorced" {{ old('marital_status') || $employee->marital_status === 'Divorced' ? 'selected' : null }}>Divorced</option>
                                                                <option value="Widowed" {{ old('marital_status') || $employee->marital_status === 'Widowed' ? 'selected' : null }}>Widowed</option>
                                                                <option value="In a Relationship" {{ old('marital_status') || $employee->marital_status === 'In a Relationship' ? 'selected' : null }}>In a Relationship</option>
                                                            </select>
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" name="children" class="form-control" value="{{ old('children') ?? $employee->children }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group fv-plugins-icon-container">
                                                            <label>Number of Dependants</label>
                                                            <input type="number" name="dependants" class="form-control" value="{{ old('dependants') ?? $employee->dependants }}">
                                                        </div>
                                                    </div>
                                                </div>

                                                <h4 class="mb-10 font-weight-bold text-dark">Dependants</h4><br>
                                                <textarea class="row" id="dependants_list" name="dependants_list[]">{{ $dependant_collection }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="next_of_kin_name" value="{{ old('next_of_kin_name') ?? $employee->next_of_kin_name }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="next_of_kin_relationship" value="{{ old('next_of_kin_relationship') ?? $employee->next_of_kin_relationship }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="next_of_kin_address" value="{{ old('next_of_kin_address') ?? $employee->next_of_kin_address }}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="next_of_kin_phone" value="{{ old('next_of_kin_phone') ?? $employee->next_of_kin_phone}}">
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="date" class="form-control form-control-solid form-control-lg" name="date_employed" value="{{ old('date_employed') ?? $employee->date_employed }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="date" class="form-control form-control-solid form-control-lg" name="date_of_exit" value="{{ old('date_of_exit') ?? $employee->date_of_exit }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-control" name="department">
                                                                ...
                                                                @foreach($departments as $dept)
                                                                    <option value="{{ $dept->id }}" {{ old('department') || $employee->department_id == $dept->id ? 'selected' : null }}>{{ $dept->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <!--end::Input-->
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" class="form-control form-control-solid form-control-lg" name="experience" value="{{ old('experience') ?? $employee->experience }}">
                                                        </div>
                                                        <!--end::Input-->
                                                    </div>
                                                </div>
                                            ...
                                            <div class="pb-5" data-wizard-type="step-content">
                                                ...
                                                <textarea class="row" id="education_history" name="education_history[]">
                                                    {{ $history_collection }}
                                                </textarea>
