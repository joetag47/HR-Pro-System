<div class="tab-pane p-3 px-lg-7 py-lg-5 fade show active" id="kt_aside_tab_1">
    ...
    <h3 class="p-2 p-lg-3 my-1 my-lg-3">Company Profile</h3>
        ...
        <div class="list-item hoverable shadow mb-10 p-5">
            <div class="d-flex align-items-center">
                <div class="d-flex flex-column flex-grow-1 mr-2">
                    <span class="text-dark-75 font-size-h6 mb-0">54</span>
    ...
    <div class="list list-hover">
        ...
        <div class="list-item hoverable shadow mb-10 p-5">
            <div class="d-flex align-items-center">
                <div class="d-flex flex-column flex-grow-1 mr-2">
                    <span class="text-dark-75 font-size-h6 mb-0">54</span>
                    <a href="{{ route('company.department.index') }}" class="text-muted text-hover-primary font-weight-bold">Employees</a>
                </div>
                <div class="symbol symbol-40 symbol-light mr-4">
						<span class="symbol-label bg-primary">
