        ...
        <div class="list-item hoverable shadow mb-10 p-5">
            <div class="d-flex align-items-center">
                <div class="d-flex flex-column flex-grow-1 mr-2">
                    <span class="text-dark-75 font-size-h6 mb-0"></span>
                    <a href="{{ route('users.index') }}" class="text-muted text-hover-primary font-weight-bold">Users</a>
                </div>
    ...
    <div class="list list-hover">
        ...
        <div class="list-item hoverable shadow mb-10 p-5">
            <div class="d-flex align-items-center">
                <div class="d-flex flex-column flex-grow-1 mr-2">
                    <span class="text-dark-75 font-size-h6 mb-0"></span>
                    <a href="{{ route('roles.index') }}" class="text-muted text-hover-primary font-weight-bold">Roles</a>
                </div>
                <div class="symbol symbol-40 symbol-light mr-4">
						<span class="symbol-label bg-primary">
